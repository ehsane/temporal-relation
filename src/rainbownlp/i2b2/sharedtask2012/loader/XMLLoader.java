...
//		<EVENT id="E0" start="1" end="10" text="Admission" modality="FACTUAL" polarity="POS" type="OCCURRENCE" />
		...
		if (line.matches("<(EVENT|TIMEX3|SECTIME).*") )
		{
			...
			Artifact startArtifact = Artifact.findInstanceByStartIndex( text_file_partial_path, annotation.startChar);
			...
			{
				startArtifact = Artifact.findInstanceByStartIndex( text_file_partial_path, annotation.startChar+1);
			}
